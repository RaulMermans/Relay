...
External source
  ...
  -> Report model
  -> Dedicated report preview
  -> Explicit browser print / Save as PDF
```
...
| Report model -> Preview/print | Structured report model | Accessible HTML preview and browser-owned print dialog | Renderer input completeness, layout, and stale-report eligibility | Keep the current preview; block stale/blocked export; allow explicit refresh or retry |
