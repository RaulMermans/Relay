...
| T-596–597 | Case-study README and architecture documentation | In progress |
| T-598 | Synthetic production screenshots | Pending |
...
| T-604 | Final release verification | Pending after final documentation/assets |
| T-605 | Release tag/version | Pending — package remains private `0.1.0`; no version policy supports a tag yet |
| T-606–609 | Release notes, case-study material, metrics status, and Vercel documentation | In progress |
| T-610 | Final independent review | Pending |
